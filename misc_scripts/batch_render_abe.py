...
class Multi_Render(bpy.types.Operator):
    ...
    # models (view layers)
    default_models = ['abe_game', 'abe_game_orange', 'abe_fmv', 'mud_green_game', 'mud_green_game_orange', 'mud_green_fmv', 'mud_blind_game', 'mud_blind_fmv']
    gib_models = ['gibs_abe_game', 'gibs_abe_game_orange', 'gibs_abe_fmv', 'gibs_mud_green_game', 'gibs_mud_green_game_orange', 'gibs_mud_green_fmv', 'gibs_mud_blind_game', 'gibs_mud_blind_fmv']
    only_game_abe = ['abe_game']
    ...
    def get_models(self, model_type):
        if model_type == 'default':
            return self.default_models # change this to only render select models
        if model_type == 'gibs':
